...
void main() {
  test('web and Android premium offer is USD 100 for 12 months', () {
    expect(webAndroidPremiumAnnualPriceUsd, 100);
    expect(webAndroidPremiumAnnualTermMonths, 12);
    expect(webAndroidPremiumAnnualPriceLabel, r'$100 USD per year');
